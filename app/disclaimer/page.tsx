    ...
    <main className="min-h-screen bg-slate-950 text-white py-20">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="space-y-8 text-slate-300">
          <section className="p-6 rounded-lg border-2 border-amber-500/50 bg-amber-500/10">
            <h2 className="text-2xl font-bold text-amber-200 mb-4">⚠️ Important Disclaimer</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Report Accuracy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">No Guarantee of Accuracy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">False Report Consequences</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Verify Before Acting</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Report a False Report</h2>
            <p>
          ...
          <div className="mt-12 p-6 rounded-lg border-2 border-red-500/50 bg-red-500/10">
