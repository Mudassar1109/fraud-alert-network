    ...
    <main className="min-h-screen bg-slate-950 text-white py-20">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="space-y-8 text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">4. Public Visibility</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">8. GDPR & Your Rights</h2>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:privacy@fraudalertnetwork.com" className="text-red-300 hover:text-red-100">
