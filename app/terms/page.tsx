    ...
    <main className="min-h-screen bg-slate-950 text-white py-20">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="space-y-8 text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">2. User Responsibility</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">4. Report Authenticity</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">8. Rate Limiting & Abuse Prevention</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:legal@fraudalertnetwork.com" className="text-red-300 hover:text-red-100">
                legal@fraudalertnetwork.com
              </a>
            </p>
          </section>

          <div className="mt-12 p-6 rounded-lg border border-red-500/30 bg-red-500/10">
